...
<div id="outer-container">
    <div id="container">
        <div id="top">
            ...
            <div id="nav">
                <ul id="topnav" class="sf-menu">
                    ...
                    <li><a href="${ctx}/music" class="current">Discovery</a></li>
        ...
        <div id="content">
            <div class="main">
                <h2 class="title_pattern uppercase"><span>All songs</span></h2>
                <ul class="recentpost">
            ...
            success: function (res){
                ...
                if(code === 2000){
                    ...
                    dataList.forEach(function(item){
                        ...
                        if(item.fileUrl){
                            html.push('<a href="javascript:listen(\''+item.fileUrl+'\',\''+item.musicName+'\')" class="listen">Listen</a>')
                        }
                        html.push('<a href="javascript:collect(\''+item.id+'\')" class="listen">Collect</a>')
