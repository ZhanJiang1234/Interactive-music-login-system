...
<div id="outer-container">
    <div id="container">
        ...
        <div id="content">
            <div class="main">
                <h2 class="title_pattern uppercase"><span>All songs</span><a href="${ctx}/music/info" style="margin-left: 30px">upload</a></h2>
...
<script>
            ...
            success: function (res){
                ...
                if(code === 2000){
                    ...
                    dataList.forEach(function(item){
                        ...
                        html.push('<a href="javascript:deleteSong(\''+item.id+'\')" class="listen">Delete</a>')
                        html.push('<a href="javascript:updateSong(\''+item.id+'\')" class="listen">Update</a>')
    ...
    function deleteSong(musicId){
        $.ajax({
            type: 'get',
            url: '${ctx}/music/delete?musicId='+musicId,
            dataType: 'json',
            success: function(res){
                let code = res.code
                if(code===2000){
    ...
    function updateSong(musicId){
        location.href = '${ctx}/music/info?musicId='+musicId
    }
</script>
